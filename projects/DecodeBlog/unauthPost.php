...
<head>
    ...
    <link rel="stylesheet" href="css/comps/3blog_page.css">
...
<?php include "views/header2.php"; ?>    
    ...
    <div class="container">
        ...
        <div class="blog-comment--leave">
            <p>Чтобы оставить комментарий <a href="reg.html"> зарегистрируйтесь</a>, или <a href="login.html">войдите</a> в аккаунт.</p>
        </div>
